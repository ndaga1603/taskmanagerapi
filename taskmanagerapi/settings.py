...
DEBUG = os.getenv("DEBUG", "False") == "True"  # True if DEBUG=True in .env file
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',                            # Default, but explicitly set for clarity
    'ROTATE_REFRESH_TOKENS': True,                   # Issue new refresh token on refresh
    'BLACKLIST_AFTER_ROTATION': True,                # Blacklist old refresh tokens (requires additional setup)
}
